...
[Semantic Versioning](https://semver.org/spec/v2.0.0.html). The most recent tagged release is `v0.9.0`;
...
[Unreleased]: https://github.com/vasovagal/vagus/compare/v0.9.0...HEAD
