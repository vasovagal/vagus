...
| Opt-in safe/research tracing | ordinary spans + standard JSON/OTLP exporters | explicit content/export consent; no eval changes | accepted (ADR 0030) |
...
- **M3 — tier-2 bounded skill** *(shipped; tightened 2026-08-12)*: `skills/vagus-search/SKILL.md` runs
  ...
  (G8). The same Agent Skill installs for Claude Code and pi; vagus-process-inbox learns the same window grammar.
