...
- `0012-three-tier-retrieval.md` — floor / shell+local / Opus-skill tiers, channel-selected. *(amended: tier-2 skill is two-phase — compact hits + `vagus chunk` body fetch.)*
